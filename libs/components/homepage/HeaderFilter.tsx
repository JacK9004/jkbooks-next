...
// 	const [openAge, setOpenAges] = useState(false);
// 	const [bookCollection, setBookCollection] = useState<BookCollection[]>(Object.values(BookCollection));
// 	const [propertyType, setBookType] = useState<BookType[]>(Object.values(BookType));
...
// 			if (!collectionRef?.current?.contains(event.target)) {
...
// 			if (!agesRef?.current?.contains(event.target)) {
// 				setOpenAges(false);
// 			}
// 		};
...
// 	const bookAgeSelectHandler = useCallback(
// 		async (value: any) => {
// 			try {
// 				setSearchFilter({
// 					...searchFilter,
...
// 			} catch (err: any) {
// 				console.log('ERROR, bookAgeSelectHandler:', err);
// 			}
// 		},
// 		[searchFilter],
// 	);
