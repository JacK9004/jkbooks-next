    ...
    <Stack direction="row" width="100%" spacing={2} className="pcWrap">
          ...
          <List sx={{ textAlign: 'center' }}>
            <ListItem sx={{ padding: 0 }}>
              <Link href="/_admin/users" target="_blank" style={{ textDecoration: 'none' }}>
                <Typography variant="subtitle2" color={user?.memberType === 'PUBLISHER' ? 'primary' : 'inherit'}>
                  {user?.memberType}
                </Typography>
              </Link>
            </ListItem>
      ...
      <Stack direction="column" spacing={2} sx={{ flex: 1, padding: '10px' }}>
        ...
        <List sx={{ display: 'flex', flexDirection: 'row', padding: 0, gap: '0px' }}>
          {[
            { category: 'addProperty', text: 'Add Book', icon: '/img/icons/newTab.svg', activeIcon: '/img/icons/whiteTab.svg' },
            { category: 'myProperties', text: 'My Books', icon: '/img/icons/home.svg', activeIcon: '/img/icons/homeWhite.svg' },
            { category: 'recentlyVisited', text: 'Recently Visited', icon: '/img/icons/search.svg', activeIcon: '/img/icons/searchWhite.svg' },
            { category: 'myFavorites', text: 'My Favorites', icon: '/img/icons/like.svg', activeIcon: '/img/icons/likeWhite.svg' },
            { category: 'followers', text: 'My Followers', icon: '/img/icons/followers.png', activeIcon: '/img/icons/followers.png' },
            { category: 'followings', text: 'Following', icon: '/img/icons/followings.png', activeIcon: '/img/icons/followings.png' },
            { category: 'myArticles', text: 'Articles', icon: '/img/icons/discovery.svg', activeIcon: '/img/icons/discoveryWhite.svg' },
            { category: 'writeArticle', text: 'Write Article', icon: '/img/icons/newTab.svg', activeIcon: '/img/icons/whiteTab.svg' },
