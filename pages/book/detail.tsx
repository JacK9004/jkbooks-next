...
const BookDetail: NextPage = ({ initialComment, ...props }: any) => {
	...
	const {
		...
		onCompleted: (data: T) => {
			...
			if (data?.getBook) setSlideImage(data?.getBook?.bookImages[0]);
		},
	});
	const {
						...
						<Stack className={'property-info-config'}>
							...
							<Stack className={'right-config'}>
								<Stack className={'info-box'}>
									<Typography className={'main-title'}>Order Information</Typography>
							...
							<Stack className={'prop-desc-config'}>
								...
								<Typography className={'title'}>Product Details</Typography>
									...
									<Box component={'div'} className={'info'}>
										...
										<Typography className={'data'}>{book?.bookLanguages}</Typography>
									</Box>
									<Box component={'div'} className={'info'}>
										<Typography className={'title'}>ISBN:</Typography>
										<Typography className={'data'}>{book?.bookISBN}</Typography>
									</Box>
									<Box component={'div'} className={'info'}>
										<Typography className={'title'}>Pages:</Typography>
										<Typography className={'data'}>{book?.bookPages}</Typography>
									</Box>
									<Box component={'div'} className={'info'}>
										<Typography className={'title'}>Published:</Typography>
								...
								<Stack className={'divider'}></Stack>
								<Stack className={'column'}>
									<Typography className={'title'}>About The Author</Typography>
									<Typography className={'data'}>{book?.bookAuthor}</Typography>
								...
								<Stack className={'leave-review-config'}>
									<Typography className={'main-title'}>Customer Reviews</Typography>
									<Typography className={'review-title'}>Write a Review</Typography>
									<textarea
